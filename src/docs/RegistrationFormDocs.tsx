...
const RegistrationFormDocs: React.FC = () => {
  ...
  const handleSubmit = (data: {
    ...
    setTimeout(() => {
      setLoading(false);
      if (showError) {
        setError("El email ya está registrado. Usa otro email.");
      } else {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <Card title="RegistrationForm - Template de Formulario de Registro">
        <div className="space-y-8">
          <section>
            ...
            >
              Template pre-construido para formularios de registro de usuarios. Incluye
              campos de nombre, apellido, email, contraseña y confirmación con validaciones.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="flex items-center gap-4 mb-4">
              <Checkbox
                label="Simular error en registro"
                checked={showError}
          ...
          <section>
            ...
            <pre className="bg-gray-100 p-4 rounded-lg text-sm overflow-x-auto">
              <code>{`import { RegistrationForm } from "flysoft-react-ui";
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  <tr className="border-b">
                    ...
                    <td className="p-2"><code>{"(data: { firstName, lastName, email, password, confirmPassword }) => void"}</code></td>
                    <td className="p-2">-</td>
...
export default RegistrationFormDocs;
